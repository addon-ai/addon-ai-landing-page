      ...
      <div className={shared.wrap}>
        <div className={styles.header}>
          <div className={`${shared.reveal} ${shared.revealed} ${shared.badge} ${shared.badgeGlassGradient} ${styles.badge}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
            <span style={{ color: '#ffffff' }}>Comparativa</span>
          </div>
          <h2 className={`${shared.reveal} ${shared.revealed} ${styles.title}`}><span className={shared.gradientText}>Addon AI</span> vs. Big Four</h2>
        </div>
