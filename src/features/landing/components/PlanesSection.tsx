      ...
      <div className={shared.wrap}>
        ...
        <div className={`${shared.cols3} ${styles.grid}`}>
          {[
            ...
            <div key={plan.name} className={`${shared.glassBisel} ${shared.cardHover} ${shared.reveal} ${badgeVisible ? styles.revealed : ''} ${styles.planCard}`} style={plan.popular ? { border: '1px solid rgba(6,182,212,0.3)' } : {}}>
